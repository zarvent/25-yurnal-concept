...
import { Pencil, BookOpen, Sparkles, Lock, BotMessageSquare } from 'lucide-react';
import { cn } from '@/lib/utils';
import { Button } from '@/components/ui/button';
import { UserNav, PremiumModal } from '@/components/user-nav';
import { Separator } from '@/components/ui/separator';

const navItems = [
  { href: '/today', label: 'Hoy', icon: Pencil },
  { href: '/journal', label: 'Diario', icon: BookOpen },
  { href: '/reflections', label: 'Reflexiones', icon: Sparkles },
];

const pageTitles: { [key: string]: string } = {
  '/today': 'Tu Entrada de Hoy',
  '/journal': 'Tu Diario',
